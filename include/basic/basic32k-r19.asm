...
WORDS:  defb    'E'+80H,"ND"         ; from here the list contains the COMMANDS
        ...
        defb    'S'+80H,"CREEN"         ; mod by Leonardo Miliani
        ...
        defb    'M'+80H,"ONITOR"
        defb    'S'+80H,"ET"
        defb    'R'+80H,"ESET"          ; mod by Leonardo Miliani
        defb    'P'+80H,"RINT"
        defb    'C'+80H,"ONT"
        defb    'L'+80H,"IST"
        defb    'C'+80H,"LEAR"
...
WORDTB: defw    PEND
        ...
        defw    RESET        ; mod function: now it resets the system
        defw    PRINT
        defw    CONT
        defw    LIST
        defw    CLEAR
...
ZPLUS   equ     0AFH            ; +          <-- from here, there are the math operators
ZMINUS  equ     0B0H            ; -
ZTIMES  equ     0B1H            ; *
ZDIV    equ     0B2H            ; /
ZOR     equ     0B5H            ; OR
...
ZEQUAL  equ     0B7H            ; M
ZLTH    equ     0B8H            ; <
ZSGN    equ     0B9H            ; SGN        <-- from here, there are the commands
ZPOINT  equ     ZSGN+016H       ; POINT      ; if the user enters a custom function,
ZLEFT   equ     ZSGN+01EH       ; LEFT$      ; he/she must increment these two pointers by 1
