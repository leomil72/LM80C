...
NULLS           equ     INPORT+$02      ; (1) Number of nulls
LWIDTH          equ     NULLS+$01       ; (1) Terminal width
...
SGNRES          equ     WRKSPC+$E5      ; (1) Sign of result
TMRCNT          equ     WRKSPC+$E6      ; (4) TMR counter for 1/100 seconds
...
ZSGN    equ     $C2             ; SGN       <-- from here, there are the functions
ZPOINT  equ     $D8             ; POINT     ; if the user enters a custom function,
ZLEFT   equ     $E0             ; LEFT$     ; he/she must increment these two pointers by 1
...
OUTIT:  ;call    SND2VID         ; call    OUTC            ; Output the character entered
        jp      MORINP          ; Get another character
