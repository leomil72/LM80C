...
SETTOP: call    CURSOR_OFF      ; disable cursor
        ...
        ld      IX,JPDISK+1     ; point to 1st address of DOS jump table
        ld      B,$05           ; 5 entries
        ld      DE,REM          ; address of REM routine
CPDSTB: ld      (IX),E
        inc     IX
        ld      (IX),D
        inc     IX
        ...
        ld      DE,0-$0010
        jr      SETNOD
SETDSR: ld      DE,0-$0F00      ; no, so reserve RAM occupied by DOS & I/O buffers
SETNOD: add     HL,DE
...
SIGNON: defb    "LM80C BASIC 3.24 ",251,"2021 L.Miliani"
