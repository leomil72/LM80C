...
SETTOP: call    CURSOR_OFF      ; disable cursor
        ...
        DEFINE  DOSNTRS 11      ; DOS entries <-- CHANGE THIS VALUE TO ALIGN IT WITH THE NUMBER OF ENTRIES
...
SIGNON: defb    "LM80C BASIC 3.26 ",251,"2021 L.Miliani"
...
FNCTAB: defw    SGN
        ...
        defw    JPEXI       ; added by Leonardo Miliani
        defw    LEN
        defw    STR
        defw    VAL
        defw    ASC
...
WORDS:  defb    'E'+$80,"ND"            ; from here the list contains the COMMANDS
        ...
        defb    'E'+$80,"XIST"          ; added by Leonardo Miliani
        defb    'L'+$80,"EN"
        defb    'S'+$80,"TR$"
        defb    'V'+$80,"AL"
        defb    'A'+$80,"SC"
...
ZLEFT   equ     $F0             ; LEFT$     <-- if the user enters a custom function anywhere,
...
CNTPLOT:push    HL              ; store HL ** do NOT remove these PUSHs since this
...
RESET:  ld      E,$00           ; full RESET
RESET2: call    DISNMI          ; disable NMI vector
