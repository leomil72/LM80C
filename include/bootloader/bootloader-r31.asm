...
FWVER:          defm    'FW R3.1',$20,__date__,$20,__time__,$00
;------------------------------------------------------------------------------
...
CHK_TXA:        ld      A,(SERIALS_EN)  ; load serial status
                and     $01             ; check if serial 1 is enabled
                jp      Z,TXA_EXIT      ; no, jump over
...
HELLOWRLD:      ld      C,$09           ; 8 LEDs to be turned off + 1 more step to turn off the last LED
                ld      A,%11001111     ; set PIO port B to mode 3 (mode control)
                out     (PIO_CB),A
