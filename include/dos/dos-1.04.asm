...
; destroys: AF, IX
PRN_WHEX:   push    DE              ; store DE
            ld      D,B             ; load iterations into D
...
BYTEHEX:    push    BC              ; store BC
            push    DE              ; store DE
            call    BYT2ASC         ; convert to HEX and get back into BC
            ld      A,B             ; print left nibble
            call    OUTC
            ld      A,C             ; print right nibble
            call    OUTC
            pop     DE              ; retrieve DE
            pop     BC              ; retrieve BC
            ret                     ; return to caller
