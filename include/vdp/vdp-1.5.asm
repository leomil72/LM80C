...
RPT104:         call    LOADLOGOCHRS
                inc     DE              ; next logo pattern
                djnz    RPT104
                ; show logo/message, play a beep, check for SHIFT pressure (to disable DOS), and wait a while
                ld      B,$02           ; two times
                xor     A               ; reset A
                ld      D,A             ; 256 times
                ld      E,A             ; x 256 times
    ...
    IFDEF LM80C64K
                inc     A               ; by default, I/O DOS buffer is enabled on LM80C 64K, disabled on LM80C
    ENDIF
...
DEC_D:          nop                     ; does nothing...
    ...
    IFDEF LM80C64K
                call    CHKSPCK         ; check if special key (CTRL) has been pressed on keyboard
                                        ; on LM80C 64K, you can disabled the I/O DOS buffer, on LM80C you can't
    ENDIF
                djnz    DEC_D           ; repeat
ERASECLRTBL:    ; erase color table
                ...
                LD_VDP_DAT              ; VDP address for passing data
