...
10320 Z2=P(T)
10325 LOCATE 23,23:PRINT SPC(7);
...
30270 RESTORE 40070
30280 FOR I=0 TO 191:READ X:VPOKE 1024+I,X:VPOKE 1216+I,X
30290 VPOKE 1408+I,X:VPOKE 1600+I,X:NEXT
30300 FOR I=0 TO 15:READ X:VPOKE 1824+I,X:NEXT:REM EMPTY SQUARES
30310 FOR I=8208 TO 8210:VPOKE I,&H15:NEXT
30320 FOR I=8211 TO 8213:VPOKE I,&H14:NEXT
30330 FOR I=8214 TO 8216:VPOKE I,&HF5:NEXT
30340 FOR I=8217 TO 8219:VPOKE I,&HF4:NEXT
30350 VPOKE 8220,&H45
30360 RETURN
