...
90 REM
100 REM
102 REM INIZIALIZZAZIONE INIZIALI
103 REM
100 GOSUB 8000
110 PRINT:PRINT TAB(10);"O T H E L L O":PRINT
...
267 PRINT "Quale colore scegli (B/N)";:Z=INKEY(0)
270 Z=INKEY(10) AND 223:IF Z<>ASC("B") AND Z<>ASC("N") THEN 270
280 IF Z=ASC("B") THEN PG=15:PRINT "B":ELSE PC=15:PRINT "N"
290 LOCATE 0,6:PRINT SPC(32);
292 LOCATE 0,6:PRINT "Livello gioco (1/2)";:Z=INKEY(0)
...
320 FOR I=0 TO 7:LOCATE11,2+I*2:PRINT CHR$(65+I);
...
355 LOCATE 19,8:PRINT CHR$(192);:LOCATE21,8:PRINT CHR$(160);
360 LOCATE 19,10:PRINT CHR$(160);:LOCATE21,10:PRINT CHR$(192);
...
1007 SOUND 3,0,1:RESTORE 10100
1010 LOCATE 0,20:PRINT SPC(32);
1012 LOCATE 0,20:PRINT "La tua mossa (es. A1) ";:VOLUME 3,9:A=INKEY(0)
1014 READ X,Y:IF X=0 THEN RESTORE 10100
1016 SOUND 3,X,0:ZZ=INKEY(Y)
1018 IF ZZ=0 THEN 1014
1020 ZZ=ZZ AND 223:IF ZZ<65 OR ZZ>72 THEN 1080
1022 S=(ZZ-64)*10:PRINT CHR$(ZZ);
1024 READ X,Y:IF X=0 THEN RESTORE 10100
1026 SOUND 3,X,0:SS=INKEY(Y)
1028 IF SS=0 THEN 1024
1030 IF SS<48 OR SS>57 THEN 1080
1040 PRINT CHR$(SS);:SOUND 3,0,1
...
2100 LOCATE 0,20:PRINT "La mia mossa e' ";
2110 PRINT CHR$(INT(Q/10)+64);CHR$(Q-INT(Q/10)*10+48);SPC(14);
...
2590 NEXT:RETURN
3000 REM
3002 REM SUBROUTINE SCELTA MOSSA CPU AL 2 LIVELLO
3003 REM
...
4003 REM
4004 LOCATE 0,20
4020 IF G>C THEN PRINT " Bravo - Hai VINTO ";SPC(45);
4030 IF C=G THEN PRINT " Stavolta siamo pari ";SPC(43);
4040 IF C>G THEN PRINT " H O    V I N T O !!! ";SPC(42);
4050 RESTORE 10200
4055 READ X,Y:SOUND 3,X,0:PAUSE Y
4060 IF X<>0 THEN 4055
4065 SOUND 3,0,1:GOSUB 6900
4070 LOCATE0,20:PRINT SPC(32);:PRINT "Giochi ancora (S/N)":Z=INKEY(0)
4080 Z=INKEY(10) AND 223:IF Z=ASC("S") THEN CLS:GOTO 200
4090 IF Z<>"N" THEN 4070
4100 CLS:PRINT "C I A O !":END
4500 LOCATE 0,20:PRINT "H O    V I N T O !!!";SPC(12);
6000 REM
...
7000 REM
7002 REM SUBROUTINE CONTROLLO VALIDITA' MOSSA
7003 REM
...
7050 NEXT:RETURN
8000 REM
8020 REM INIZIALIZZAZIONE SCHERMO E SCACCHIERA
8030 REM
