...
470 IFSC(U,V)=0THENGOSUB490
480 RETURN
490 REM
500 PNS=1:IFABS(Y-V)=2THENQ=99:MA=1
...
1060 LOCATEPSX,2:IFPNS=1THENPNS=0:C$=" PENSO ":GOTO1064
1062 PNS=1:C$="       "
1064 PRINTC$;:GOTO1080
1070 PRINT"     ";:PNS=1
...
10090 PRINT:PRINT"PREMI UN TASTO..."
