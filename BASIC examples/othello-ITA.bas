...
103 REM
100 GOSUB 8000
110 PRINT:PRINT TAB(9);"O T H E L L O":PRINT:GOSUB 9000
115 DIM AP(99),BP(7),CP(99),DP(99)
120 RESTORE 10000:FOR I=0 TO 7:READ BP(I):NEXT
130 FOR I=1 TO 4:FOR J=1 TO 8:READX:Y=I*10+J
...
1012 LOCATE 0,20:INPUT "La tua mossa (es. A1)";ZZ$:GOSUB 9100
...
2030 ON LV GOSUB 2500,3000
2040 IF Q<>O THEN 2100
2050 LOCATE 0,20:PRINT "Passo il turno";SPC(18);
2060 FOR I=4000 TO 3700 STEP -25:SOUND3,I,0:PAUSE 5:NEXT:SOUND 3,0,1
...
2560 M=0:GOSUB 7010
2570 IF AP(M)=AP(Q)ANDRND(1)<.5 THEN Q=M
...
4050 RESTORE 10200
4055 READX,Y:SOUND 3,X,0:PAUSE Y
4060 IF X<>0 THEN 4055
4065 SOUND 3,0,1:GOSUB 6900
4070 LOCATE 0,20:PRINT SPC(32);:PRINT "Giochi ancora (S/N)":Z=INKEY(0)
...
9030 GOTO 9010
9099 REM CONVERTE UNA STRINGA IN LETTERE MAIUSCOLE
