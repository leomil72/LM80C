...
1012 LOCATE 0,20:PRINT"YOUR MORE (e.g. A1) ";:VOLUME 0,10
1014 READX,Y:IFX=0THENRESTORE10100
1016 SOUND3,X,0:ZZ=INKEY(Y)
1018 IF ZZ=0 THEN 1014
1020 IF ZZ<65 OR ZZ>72 THEN 1080
...
1050 S=S+(SS-48):PA=PC:PP=PG:M=0:VOLUME 0,15
1070 LOCATE 0,20:PRINTSPC(32);:GOSUB7000:IFM<>OTHEN1100
1080 LOCATE 0,20:PRINT"ILLEGAL MOVE - REPEAT           ";
1085 VOLUME 0,15
