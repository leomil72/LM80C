...
60 REM ************************************
100 GOSUB 2500:X=RND(-ABS(TMR(0)))
110 MX=51:MH=51:MY=50:ME=200
120 DIM S1$(12)
130 DIM XI(MX):REM UNITA' DI INPUT + BIAS
140 DIM H(MH):REM UNITA' NASCOSTE + BIAS
150 DIM Y(MY):REM UNITA' DI OUTPUT
160 DIM D(MY):REM UNITA' DI OUTPUT DESIDERATO
170 DIM W1(MX,MH):REM MATRICE PESI DI LIVELLO 1
180 DIM W2(MH,MY):REM MATRICE PESI DI LIVELLO 2
185 DIM EH(MH):REM ERRORE SU UNITA' NASCOSTE
...
840 PRINT "Tasso di apprendimento (0.001-0.999)";:INPUT EP$
...
890 EE=0.0:PRINT:PRINT "Apprendimento..."
...
1160 FOR I=1 TO NX:XI(I)=0.0:NEXT:XI(NX+1)=1.0
1170 FOR K=1 TO NH:H(K)=0.0:NEXT:H(NH+1)=1.0
...
1420 FOR K=1 TO NH:PRINT W1(I,K);" ";:NEXT:PRINT
...
1460 PRINT " ";
1470 FOR K=1 TO NH:PRINT K;"H ";:NEXT:PRINT:PRINT
1480 FOR I=1 TO NX+1:PRINT I;"X ";
1490 FOR K=1 TO NH:PRINT W1(I,K);" ";:NEXT:PRINT
1500 RETURN
1599 REM *** <SALVA> ***
1600 CLS:PRINT "Nome del file su cui salvare i dati"
1610 INPUT FL$:IF FL$="" THEN RETURN
1620 OPEN FL$,1,1:PRINT "Salvo prima parte..."
1630 BN=NX:GOSUB 6000:BN=NH:GOSUB 6000:BN=NY:GOSUB 6000
1640 FOR K=1 TO NH:FOR I=1 TO NX+1
1650 BN=W1(I,K):GOSUB 6000
1660 NEXT:NEXT:PRINT "Salvo seconda parte..."
...
2060 LOCATE 0,23:PRINT SPC(39);:LOCATE C-1,23:PRINT "===";
...
5999 REM *** SAVE NUMBERS TO FILE ***
6000 BN$=STR$(BN)
6010 FOR VB=1 TO LEN(BN$)
6020 PUT 1,ASC(MID$(BN$,VB,1))
6030 NEXT
6040 PUT 1,0:REM STRING TERMINATOR CHAR
6050 RETURN
6999 REM *** LOAD NUMBERS FROM FILE ***
7000 BN$=""
