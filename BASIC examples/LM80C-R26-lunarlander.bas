...
230 GOSUB1280
231 LOCATE22,16
232 PRINTCHR$(149);:FORI=1TO8:PRINTCHR$(157);:NEXT:PRINTCHR$(150);
233 LOCATE22,17:PRINTCHR$(158);" LUNAR  ";CHR$(158);
234 LOCATE22,18:PRINTCHR$(158);" LANDER ";CHR$(158);
235 LOCATE22,19
236 PRINTCHR$(152);:FORI=1TO8:PRINTCHR$(157);:NEXT:PRINTCHR$(151);
240 GOSUB600
250 GOSUB1960
260 GOSUB 6600
270 AT=TI
...
330 TH=TH+1:GOSUB4100:IFR=0THENSREG7,248:SREG6,0:SREG10,0:SREG13,0:SREG11,0:SREG12,0
...
765 REM
770 R1=R:IFR1=20THENVPOKE8208,&HD0:GOTO792
790 VPOKE8208,&H80
...
4002 SREG7,&B11011000:SREG10,31:SREG13,12:SREG11,0:SREG12,1:SREG6,31
...
4400 FORI=1TOLEN(A$)
4410 PRINTMID$(A$,I,1);:SOUND1,100,2:PAUSE3
4420 NEXT
4440 RETURN
4497 REM
