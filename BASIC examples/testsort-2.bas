...
1070 REM *         (SECOND REVISION 2022/03/20)          *
1080 REM *************************************************
1100 REM
1110 REM ** PRINT MAIN TITLE **
1120 SCREEN 0:RT=9:REM # OF ALGHORITHMS
...
1510 IF (RND(1)*ND<PA) THEN BX(Q)=Q:GOTO 1555
...
1570 ON ZP GOSUB 1720,1890,3000,3500,2140,3200,2630,2280,2410
...
3530 ST=0:EN=E-1:GOSUB 3590
3540 E=E-1:GOTO 3510
3545 REM HEAPIFY
3550 ST=INT((ND-2)/2)
3560 IF ST<0 THEN RETURN
3570 EN=ND-1:GOSUB 3590
3580 ST=ST-1:GOTO 3560
3585 REM SIFTDOWN
3590 RO=ST
...
56310 DATA "BUBBLE","COCKTAIL","CYCLE","HEAP","INSERTION"
56320 DATA "MERGE","QUICK","SELECTION","SHELL"
