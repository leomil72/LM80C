...
1070 REM *              (V.4 - 2022/03/26)               *
1080 REM *************************************************
1100 REM
1110 REM ** PRINT MAIN TITLE **
1120 SCREEN 0:RT=11:REM # OF ALGORITHMS
...
1430 ND=VAL(N$):IF ND>999 OR ND<10 THEN 1410
...
1500 REM *********************
1501 REM * RANDOM GENERATION *
1502 REM *********************
1504 I=RND(-ABS(TMR(0))):REM
