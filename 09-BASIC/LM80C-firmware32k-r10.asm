...
;------------------------------------------------------------------------------
; interrupt vector for CH3 Timer
                org $16
                defw CH3_TIMER
;------------------------------------------------------------------------------
; check serial status
...
;CH1 & CH2 disabled (they are not used yet in this program)
                ...
                out (CTC_CH2),a     ; CH2 doesn't run

;init CH3
;CH1 divides CPU CLK by (144*256) providing an interrupt signal at 100 Hz (1/100 sec).
;f = CPU_CLK/(144*256) => 3,686,400 / ( 144 * 256 ) => 100Hz
