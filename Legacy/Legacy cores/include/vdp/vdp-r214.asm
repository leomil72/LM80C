...
EMPTYVIDBUF:    ld      A,(SCR_MODE)    ; check screen mode
                ...
                ld      C,$20           ; we will fill up the screen with spaces
...
RPTEMPTYBUF:    out     (C),A           ; write empty byte into VRAM
                ...
                jp      Z,EMPTYMC       ; yes, additional setup for MC
                cp      $02             ; is it graphics 2 mode?
                ret     NZ              ; no, return to caller
EMPTYG2:        ld      HL,$1800        ; yes, additional setup for G2 - load G2 name table
