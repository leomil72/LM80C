...
CHKBKSP:        cp BKSP             ; is it the backspace?
...
LOADNEXTCOL:    in a,(VDP_DAT)      ; load char
                ld (hl),a           ; store char
                inc hl              ; next cell into buffer
                ...
                ld hl,(VIDTMP2)     ; prev. source will be..
...
WRITEBUF:       ld a,(hl)           ; load char
                ...
                out (c),h           ; high byte of address
RPTEMPTYROW:    out (VDP_DAT),a     ; empty cell
                nop                 ; delay
