...
FNCTAB: defw    SGN
        ...
        defw    INT
        defw    ABS_        ; _ necessary for assembler warning
        defw    USR
        defw    FRE
        defw    INP
        defw    POS
...
; convert a number in ASCII chars into an integer into DE
...
; address must point to an ISR routine that terminates with EI/RETN instrucions
