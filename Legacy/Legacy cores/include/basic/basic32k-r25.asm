...
PBUFF       equ     CHCSNDDTN+002H      ; Number print buffer
...
ZPOINT  equ     0D2H            ; POINT      ; if the user enters a custom function,
ZLEFT   equ     0DAH            ; LEFT$      ; he/she must increment these two pointers by 1
