...
SIGNON: defb    "LM80C BASIC 3.22 ",251,"2021 L.Miliani"
...
LOAD:   call    CHKDOS          ; check if DOS is enabled
        call    LDSVPT          ; check if in direct mode and what's following
