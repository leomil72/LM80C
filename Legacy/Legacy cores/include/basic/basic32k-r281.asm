...
VIDEOBUFF       equ     WRKSPC+102H     ; (40) used for video scrolling and other purposes
VIDTMP1         equ     VIDEOBUFF+028H  ; (2) temporary video buffer
VIDTMP2         equ     VIDTMP1+002H    ; (2) temporary video buffer
...
TMPKEYBFR       equ     CHCSNDDTN+002H  ; (1) temp buffer for last key pressed
...
PROCES: ld      A,C             ; Get character
        ...
        jp      Z,CLS2          ; Yes - Clear screen & kill
        cp      CR              ; Is it enter?
...
CLS2:   call    OUTC            ; send char to screen (clear screen)
