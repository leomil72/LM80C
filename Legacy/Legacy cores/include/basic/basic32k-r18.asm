...
VIDEOBUFF   equ     WRKSPC+0FCH         ; (40) used fro scrolling and other purposes
...
; included REM and after it has been incremented.
...
ZPLUS   equ    0ADH            ; +          <-- from here, there are the math operators
ZMINUS  equ    0AEH            ; -
ZTIMES  equ    0AFH            ; *
ZDIV    equ    0B0H            ; /
ZOR     equ    0B3H            ; OR
...
ZEQUAL  equ    0B5H            ; M
ZLTH    equ    0B6H            ; <
ZSGN    equ    0B7H            ; SGN        <-- from here, there are the commands
ZPOINT  equ    ZSGN+013H       ; POINT      ; if the user enters a custom function,
ZLEFT   equ    ZSGN+01BH       ; LEFT$      ; he/she must increment these two pointers by 1
...
POKE:   call    PKEPRMS         ; Get params: address and value, return into HL and A, resp.
        ld      (DE),A          ; Load it into memory
        ret

; write a byte into VRAM
VPOKE:  call    PKEPRMS         ; Get params: address and value, return into HL and A, resp.
        push    HL              ; Store HL
