...
#include "../include/bootloader/bootloader-r212.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r212.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r212.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r212.asm"

; include utils
#include "../include/utils/utils.asm"
