...
#include "../include/bootloader/bootloader-r3132.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r3132.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r3132.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r3132.asm"
