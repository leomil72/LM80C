...
#include "../include/bootloader/bootloader-r215.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r215.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r215.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r215.asm"
