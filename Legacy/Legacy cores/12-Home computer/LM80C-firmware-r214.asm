...
#include "../include/bootloader/bootloader-r214.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r214.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r214.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r214.asm"
