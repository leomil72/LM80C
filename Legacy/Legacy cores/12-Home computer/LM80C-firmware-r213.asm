...
#include "../include/bootloader/bootloader-r213.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r213.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r213.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r213.asm"
