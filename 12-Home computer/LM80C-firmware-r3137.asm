...
#include "../include/bootloader/bootloader-r3137.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r3137.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r3137.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r3137.asm"
