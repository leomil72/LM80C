...
#include "../include/bootloader/bootloader-r21a.asm"

; incude the latest version of the VDP module
#include "../include/vdp/vdp-r21a.asm"

; incude the latest version of the PSG module
#include "../include/psg/psg-r21a.asm"

; include the latest version of the NASCOM BASIC interpreter
#include "../include/basic/basic32k-r21a.asm"
